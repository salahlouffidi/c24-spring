...
@ContextConfiguration("XPathRouter_defaultMapping.xml")
public class XPathRouterDefaultMappingTests extends BaseIntegrationTest {
    ...
    @Test
    public void receiveOnDefaultMappingChannel() throws Exception {
