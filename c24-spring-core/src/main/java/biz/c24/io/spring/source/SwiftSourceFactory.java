 ...
 * 
 */
public class SwiftSourceFactory implements SourceFactory {
	...
	public Source getSource(InputStream stream) {
	    ...
	    SwiftSource source = new SwiftSource(stream);
	...
	final protected void configure(SwiftSource source) {
	 ...
	 * @param source
	 */
	protected void doConfigure(SwiftSource source) {
	...
	public Source getSource(Reader reader) {
		SwiftSource source = new SwiftSource(reader);
